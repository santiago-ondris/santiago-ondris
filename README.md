# Santiago Ondris
**Full Stack Developer** focused on turning business requirements into high-impact software. Experientially proven to build systems that automate processes, optimize logistics, and reduce operational times.  From comprehensive modular apps to secure, offline-capable PWA access controls.  Ecosystems: Node.js | Go | .NET React & TypeScript | Cloud Infrastructure  
...
### [Wheels House](https://wheelshouse.app)
